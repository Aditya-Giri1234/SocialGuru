...
import com.aditya.socialguru.databinding.FragmentVideoMediaShowBinding
...
class VideoMediaShowFragment(val chatRoomId:String) : Fragment() {

    private var _binding: FragmentVideoMediaShowBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentVideoMediaShowBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun FragmentVideoMediaShowBinding.setListener() {
        linearBackToTop.setSafeOnClickListener {
            rvVideoMedia.smoothScrollToPosition(0)
        }

        rvVideoMedia.addOnScrollListener(object : RecyclerView.OnScrollListener() {
...
//                    MyLogger.v(tagProfile, msg = "Down scroll")
    ...
    private fun showBackToTopView() {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            if (this@VideoMediaShowFragment.isResumed) {
    ...
    private fun getData() {
        if (!chatViewModel.isDataLoaded) {
            ...
            chatViewModel.getAllMediaForChat(chatRoomId, 2)
        }
    }
    ...
    override fun onDestroyView() {
        _mediaAdapter = null
        binding.rvVideoMedia.adapter = null
        _binding = null
        super.onDestroyView()
    }
